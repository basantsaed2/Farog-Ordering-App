...
const HeaderSection = () => {
       return (
              <div className='relative overflow-hidden h-[90vh] flex flex-col sm:items-center xl:items-start sm:gap-y-20 xl:gap-y-12 px-12 sm:pt-12 xl:pt-24'>
                     <span className='mt-15 sm:text-center xl:text-start text-mainColor sm:text-3xl xl:text-5xl font-TextFontMedium sm:leading-relaxed xl:leading-relaxed'>Farog - Fresh Flavors, Unique <br className='sm:hidden xl:block' />
                            Experience
                     </span>
                     <p className=' text-secoundColor sm:text-center xl:text-start text-2xl font-TextFontMedium sm:leading-loose xl:leading-relaxed'>Welcome to Farog, where fresh ingredients <br />
