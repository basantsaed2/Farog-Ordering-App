...
const SignUpPage = () => {
       ...
       const { postData: postEmail, loadingPost: loadingEmail, response: responseEmail } = usePost({ url: 'https://aboalabdbcknd.food2go.online/api/user/auth/signup/code' }); // Destructure as an object
       const { postData: postPhone, loadingPost: loadingPhone, response: responsePhone } = usePost({ url: 'https://aboalabdbcknd.food2go.online/api/user/auth/signup/phone_code' }); // Destructure as an object
       const { postData: postSignUp, loadingPost: loadingSignUp, response: responseSignUp } = usePost({ url: 'https://aboalabdbcknd.food2go.online/api/user/auth/signup' }); // Destructure as an object
