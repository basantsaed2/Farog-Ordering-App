...
const LoginPage = () => {
       ...
       const { postData: postEmail, loadingPost: loadingEmail, response: responseEmail } = usePost({ url: 'https://aboalabdbcknd.food2go.online/customer/otp/create_code' });
       const { postData: postPhone, loadingPost: loadingPhone, response: responsePhone } = usePost({ url: 'https://aboalabdbcknd.food2go.online/api/user/auth/signup/phone_code' });
       const { postData: postLogin, loadingPost: loadingLogin, response: responseLogin } = usePost({ url: 'https://aboalabdbcknd.food2go.online/api/user/auth/login' });
       const { postData: postNewLogin, loadingPost: loadingNewLogin, response: responseNewLogin } = usePost({ url: 'https://aboalabdbcknd.food2go.online/customer/otp/change_password' });
                                                 ...
                                                 <>
                                                        ...
                                                        <div className={`${newPassState ? 'mt-16' : 'mt-5'} flex w-full flex-col items-start justify-start gap-y-4`}>
                                                               <span className='sm:text-4xl xl:text-5xl font-TextFontRegular text-secoundColor'>
                                                                      {newPassState ? 'Set Your New Password' : 'Login to Farog'}
                                                               </span>
                                                        </div>
