...
const CheckOutPage = () => {
       ...
       const { postData: postOrder, loadingPost: loadingOrder, response: responseOrder } = usePost({ url: 'https://aboalabdbcknd.food2go.online/customer/make_order?locale=ar', type: true });
